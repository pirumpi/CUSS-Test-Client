...
export namespace BiometricProviderMessage {
    export type BiometricFunctionTypeEnum = 'associate' | 'disassociate' | 'enroll' | 'get-associations' | 'identify' | 'preview' | 'purge' | 'verify';
    export const BiometricFunctionTypeEnum = {
        ...
        GetAssociations: 'get-associations' as BiometricFunctionTypeEnum,
