...
export namespace TransactionStatus {
    export type TransactionStatusIDEnum = 'amount-approval' | 'application-selection' | 'card-insertion' | 'card-removal' | 'cashback-entry' | 'pin-entry' | 'processing';
    export const TransactionStatusIDEnum = {
        AmountApproval: 'amount-approval' as TransactionStatusIDEnum,
        ApplicationSelection: 'application-selection' as TransactionStatusIDEnum,
        CardInsertion: 'card-insertion' as TransactionStatusIDEnum,
        CardRemoval: 'card-removal' as TransactionStatusIDEnum,
        CashbackEntry: 'cashback-entry' as TransactionStatusIDEnum,
        PinEntry: 'pin-entry' as TransactionStatusIDEnum,
