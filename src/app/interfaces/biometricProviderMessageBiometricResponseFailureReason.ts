...
export namespace BiometricProviderMessageBiometricResponseFailureReason {
    export type FailureCodeEnum = 'failed' | 'timeout' | 'cameraError' | 'invalidConfiguration' | 'matchFailed' | 'notIdentified' | 'poorCameraImage' | 'poorDocumentImage' | 'datasetNotFound' | 'faceNotDetected';
    export const FailureCodeEnum = {
        Failed: 'failed' as FailureCodeEnum,
        Timeout: 'timeout' as FailureCodeEnum,
        CameraError: 'cameraError' as FailureCodeEnum,
        InvalidConfiguration: 'invalidConfiguration' as FailureCodeEnum,
        MatchFailed: 'matchFailed' as FailureCodeEnum,
        NotIdentified: 'notIdentified' as FailureCodeEnum,
        PoorCameraImage: 'poorCameraImage' as FailureCodeEnum,
        PoorDocumentImage: 'poorDocumentImage' as FailureCodeEnum,
        DatasetNotFound: 'datasetNotFound' as FailureCodeEnum,
        FaceNotDetected: 'faceNotDetected' as FailureCodeEnum
    };
}