...
export namespace EPaymentMessageTransaction {
    export type TransactionTypeEnum = 'cancel' | 'pre-auth' | 'post-auth' | 'purchase' | 'refund' | 'void-purchase' | 'void-refund';
    export const TransactionTypeEnum = {
        Cancel: 'cancel' as TransactionTypeEnum,
        PreAuth: 'pre-auth' as TransactionTypeEnum,
        PostAuth: 'post-auth' as TransactionTypeEnum,
        Purchase: 'purchase' as TransactionTypeEnum,
        Refund: 'refund' as TransactionTypeEnum,
        VoidPurchase: 'void-purchase' as TransactionTypeEnum,
        VoidRefund: 'void-refund' as TransactionTypeEnum
    };
}