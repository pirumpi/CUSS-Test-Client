...
export namespace CommonUsePaymentMessage {
    export type DocumentTypeEnum = 'characteristics' | 'ePaymentMessage' | 'error-response';
    export const DocumentTypeEnum = {
        Characteristics: 'characteristics' as DocumentTypeEnum,
        EPaymentMessage: 'ePaymentMessage' as DocumentTypeEnum,
        ErrorResponse: 'error-response' as DocumentTypeEnum
    };
}