...
export namespace Feature {
    export type FeatureNameEnum = 'auto-commit' | 'pre-authorization' | 'receipt-printer' | 'signature-capture' | 'signature-cvm-supported';
    export const FeatureNameEnum = {
        AutoCommit: 'auto-commit' as FeatureNameEnum,
        PreAuthorization: 'pre-authorization' as FeatureNameEnum,
        ReceiptPrinter: 'receipt-printer' as FeatureNameEnum,
        SignatureCapture: 'signature-capture' as FeatureNameEnum,
        SignatureCvmSupported: 'signature-cvm-supported' as FeatureNameEnum
    };
}